...
global atcDropStartZ = 30   ; The Z position to start dropping the tool
global atcDropEndZ = 25   ; The Z position to stop dropping the tool
global atcDropFeed = 1800
global atcDropRPM = 1400 ; The spindle RPM to drop the tool

global atcPickupStartZ = 30
global atcPickupEndZ = 25
...
global atcOriginX = 17; {move.axes[0].min + 24}  ; X position of the first pocket's center
global atcOriginY = 87; {move.axes[1].min + 24}  ; Y position of the first pocket's center
