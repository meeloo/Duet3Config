...
description = "CNC for Duet [Seb]";
vendor = "CNC Router Parts, customised by Seb";
vendorUrl = "http://www.cncrouterparts.com";
legal = "Copyright (C) 2012-2018 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 24000;

longDescription = "Router post Duet CNC customized by Seb";
...
propertyDefinitions = {
  ...
  waitForSpindle: { title: "Wait for spindle", description: "Wait for spindle to get up to speed. -1 = request user confirmation before moving on. 0 = don't wait at all. Other value = time is seconds."}
};
...
function onSection() {
  ...
  if (insertToolCall ||
    ...
    if (!tapping || (tapping && !(properties.useRigidTapping == "without"))) {
      ...
      if (properties.waitForSpindle == -1) {
